...
public class AudioFileFunc {
    ...
    //录音输出文件
    private final static String AUDIO_RAW_FILENAME = "recording.pcm";
    private final static String AUDIO_WAV_FILENAME = "recording.wav";
    public final static String AUDIO_AMR_FILENAME = "recording.amr";
